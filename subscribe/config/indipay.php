...
return [
    ...
    */
    ...
    'ccavenue' => [                         // CCAvenue Parameters
        ...
        'redirectUrl' => env('INDIPAY_REDIRECT_URL', 'subscription/response'),
        'cancelUrl' => env('INDIPAY_CANCEL_URL', 'subscription/response'),
    ...
    'payumoney' => [                         // PayUMoney Parameters
        ...
        // Should be route address for url() function
        'successUrl' => env('INDIPAY_SUCCESS_URL', 'subscription/response'),
        'failureUrl' => env('INDIPAY_FAILURE_URL', 'subscription/response'),
    ],
    ...
    'ebs' => [                         // EBS Parameters
        ...
        // Should be route address for url() function
        'return_url' => env('INDIPAY_SUCCESS_URL', 'subscription/response'),
    ],
    ...
    'citrus' => [                         // Citrus Parameters
        ...
        // Should be route address for url() function
        'returnUrl' => env('INDIPAY_SUCCESS_URL', 'subscription/response'),
        'notifyUrl' => env('INDIPAY_SUCCESS_URL', 'subscription/response'),
    ],
